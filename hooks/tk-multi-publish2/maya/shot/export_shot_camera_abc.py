...
class MayaSessionShotCameraAlembicExportPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(MayaSessionShotCameraAlembicExportPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        ["maya.*", "file.maya"]
        """
        return ["maya.session.camera.abc"]
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSessionShotCameraAlembicExportPlugin, self).validate(
            settings, item)
        ...
        for cam in cam_list:
            for _type in cam_type:
                if _type in cam:
                    ...
                    cam_abc_path = os.path.join( abc_ver_path , cam_name + '.abc' )
...
#        mmGeom_path = os.path.join( abc_ver_path , mmGeom + '.abc' )
        ...
        if farm:
            ...
            job.projects = ['RND']
            job.spoolcwd = '/tmp'
            task = author.Task( title = 'Exporting Camera Alembic ' )
