...
class MayaSessionShotCameraAlembicPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(MayaSessionShotCameraAlembicPublishPlugin, self).settings or {}
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSessionShotCameraAlembicPublishPlugin, self).validate(
            settings, item)
