...
class MayaSessionAlembicForMariPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(MayaSessionAlembicForMariPublishPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        ["maya.*", "file.maya"]
        """
        return ["maya.session.component.abc_mari"]
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSessionAlembicForMariPublishPlugin, self).validate(
            settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(MayaSessionAlembicForMariPublishPlugin, self).publish(settings, item)
