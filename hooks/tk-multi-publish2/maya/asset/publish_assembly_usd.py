...
class MayaSessionAssemblyUSDPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(MayaSessionAssemblyUSDPublishPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        ["maya.*", "file.maya"]
        """
        return ["maya.session.assembly.usd"]
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSessionAssemblyUSDPublishPlugin, self).validate(
            settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(MayaSessionAssemblyUSDPublishPlugin, self).publish(settings, item)
