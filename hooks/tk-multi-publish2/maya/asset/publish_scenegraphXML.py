...
class MayaSessionScenegraphXMLPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(MayaSessionScenegraphXMLPublishPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        ["maya.*", "file.maya"]
        """
        return ["maya.session.scenegraphxml"]
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSessionScenegraphXMLPublishPlugin, self).validate(
            settings, item)
    ...
    def publish(self, settings, item):
        ...
        components = cmds.ls(type='pxrUsdReferenceAssembly')
        try:
            ...
            for component in components:
                abc_path = cmds.getAttr(component+".filePath").replace("usd","abc")
                maya2scenegraphXML.setReference([component],filepath=abc_path,refType="abc")

            start_frame, end_frame = _find_scene_animation_range()
            if start_frame and end_frame:
                maya2scenegraphXML.maya2ScenegraphXML([assembly],publish_path  ,start_frame,end_frame)
            else:
        ...
        super(MayaSessionScenegraphXMLPublishPlugin, self).publish(settings, item)
