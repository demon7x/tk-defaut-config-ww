...
class ScenegraphElement:
    ...
    def writeXMLCommonData(self, xmlElement):
        ...
        """
        log.debug('  calling ScenegraphElement.writeXMLCommonData for %s' % self.name)
    ...
    def readXMLCommonData(self, xmlElement):
        ...
        log.debug('  calling ScenegraphElement.readXMLCommonData for %s' % self.name)
...
if __name__ == '__main__':
    ...
    geometry1 = Reference('marketGeo', refType='abc', refFile='Marketplace/Market.abc')
