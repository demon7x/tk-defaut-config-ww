...
class MariTexturesPublishPlugin(HookBaseClass):
    ...
    def publish(self, settings, item):
        ...
        from WWUSD_MARI.Scripts import TextureExporter
        ...
        version = 1
        publish_name = "%s_texture" % (geo_name)

        current_engine = sgtk.platform.current_engine()
        context = current_engine.context

        fields["version"] = 1
        fields["name"] = context.entity['name']
        ...
        export_args = {
            ...
            "asset_type" : context.step['name'],
            "asset" : context.entity['name'],
            "dept" :  context.step['name'],
            "name" : context.entity['name'],
            "ver" : version
        }
        TextureExporter.export(export_args, publish_path,mode=False)
